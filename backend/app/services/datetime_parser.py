...
# BOLT OPTIMIZATION: Module-level tuple for day keywords avoids list creation
# overhead on every parse_natural_language_datetime call.
_DAY_KEYWORDS = (
    "tomorrow",
    "today",
    "monday",
...
def parse_natural_language_datetime(text, timezone_name=None):
    ...
    # BOLT OPTIMIZATION: Use module-level _DAY_KEYWORDS tuple and avoid
    # redundant text.lower() calls since text is lowercased at function entry.
