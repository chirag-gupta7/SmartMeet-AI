...
# BOLT OPTIMIZATION: Module-level tuple eliminates per-call list allocations and
# avoids redundant lowercasing on already lowercased text in datetime parsing.
_DAY_KEYWORDS = (
    "tomorrow",
    "today",
    "monday",
