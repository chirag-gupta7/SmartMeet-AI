...
# BOLT OPTIMIZATION: Module-level tuple for day keywords avoids list allocation
# on every parse_natural_language_datetime call and eliminates repeated
# text.lower() string allocations.
_DAY_KEYWORDS = (
    "tomorrow",
    "today",
    "monday",
