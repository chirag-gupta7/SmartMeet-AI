...
def create_meeting():
    ...
    try:
        # BOLT OPTIMIZATION: Use parse_iso_datetime from timeutils for fast,
        # allocation-free ISO8601 parsing in Python 3.11+
...
def update_meeting(meeting_id: str):
    ...
    if "start_time" in payload:
        try:
            # BOLT OPTIMIZATION: Use parse_iso_datetime for fast ISO parsing
