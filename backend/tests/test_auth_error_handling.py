...
def test_login_oversized_password_returns_401(client):
    """Oversized password in login must be rejected with 401."""
    long_password = "P" * 256
    payload = {"email": "valid@example.com", "password": long_password}
